        ...
        <div className="mt-16 flex flex-col md:flex-row gap-10 items-center">
          <div className="md:w-2/5">
            <div className="relative">
              <div className="w-full max-w-md mx-auto aspect-[3/4] overflow-hidden rounded-lg shadow-xl border border-white/20">
                <img 
              ...
              <div className="absolute -bottom-6 -right-6 w-40 h-40 bg-cyan-400/15 rounded-full -z-10"></div>
              <div className="absolute -top-6 -left-6 w-40 h-40 bg-teal-300/10 rounded-full -z-10"></div>
            </div>
          </div>
          
          <div className="md:w-3/5">
            <h3 className="text-2xl font-bold mb-4 font-serif text-white">Software Engineer & Problem Solver</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              <div className="flex items-center">
                ...
                <span className="text-gray-200"><span className="font-medium">Name:</span> Sujal Bazari</span>
              </div>
              <div className="flex items-center">
                <div className="w-2 h-2 bg-teal-300 rounded-full mr-2"></div>
                <span className="text-gray-200"><span className="font-medium">Email:</span> bazarisujal815@gmail.com</span>
              </div>
              <div className="flex items-center">
                <div className="w-2 h-2 bg-teal-300 rounded-full mr-2"></div>
                <span className="text-gray-200"><span className="font-medium">Degree:</span> B.Tech in Computer Science</span>
              </div>
              <div className="flex items-center">
                <div className="w-2 h-2 bg-teal-300 rounded-full mr-2"></div>
                <span className="text-gray-200"><span className="font-medium">Location:</span> Jalandhar, Punjab</span>
              </div>
            </div>
